...
from routers import auth, billing, documents, chat, generate, versions, automations, workspaces, api_keys, public_api, analytics, workspace_ws
...
app.include_router(workspace_ws.router)
